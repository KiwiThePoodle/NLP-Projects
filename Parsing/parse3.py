...
class EarleyChart:
    ...
    def _run_earley(self) -> None:
        ...
        rules_to_remove = set()
        for rule_list in self.grammar._expansions.values():
            for rule in rule_list:
                for element in rule.rhs:
                    if (not self.grammar.is_nonterminal(element) and element not in token_set):
        ...
        for rule in rules_to_remove:
            self.grammar._expansions[rule.lhs].append(rule)                 
